...
PrintArray(massiv);
int chislo = InputNumber("Введите число которое нужно найти в этом массиве: ");
...
for (int i = 0; i < massiv.GetLength(0); i++)
{
    for (int j = 0; j < massiv.GetLength(1); j++)
    {
        ...
        {
            Console.WriteLine($"Число {chislo} есть в массиве, позиция: {i+1}, {j+1}");
            check = true;
        }
    }
}
if (check == false) Console.WriteLine($"Числа {chislo} НЕТ в массиве");
